    ...
    option.addEventListener("click", () => {
        ...
        switch (selectedOption) {
            case "GreenFiber TV Plus (+R$16,99)":
                price500.innerText = `R$ ${(+99.99 + +16.99)
                    .toFixed(2)
                    .toString()
                    .replace(".", ",")}`;
                assinar500.href =
            ...
            case "GreenFiber TV Plus + HBOMax (+R$46,99)":
                price500.innerText = `R$ ${(+99.99 + +46.99)
                    .toFixed(2)
                    .toString()
                    .replace(".", ",")}`;
                assinar500.href =
    ...
    option.addEventListener("click", () => {
        ...
        switch (selectedOption) {
            case "GreenFiber TV Plus (+R$10,00)":
                price600.innerText = `R$ ${(+124.99 + +10)
                    .toFixed(2)
                    .toString()
                    .replace(".", ",")}`;
                assinar600.href =
            ...
            case "GreenFiber TV Plus + HBOMax (+R$40,00)":
                price600.innerText = `R$ ${(+124.99 + +40)
                    .toFixed(2)
                    .toString()
                    .replace(".", ",")}`;
                assinar600.href =
...
options800.forEach((option) => {
    option.addEventListener("click", () => {
        ...
        switch (selectedOption) {
            case "GreenFiber TV Plus (+R$10,00)":
                price800.innerText = `R$ ${(+149.99 + +10)
                    .toFixed(2)
                    .toString()
                    .replace(".", ",")}`;
                assinar800.href =
            ...
            case "GreenFiber TV Plus + HBOMax (+R$40,00)":
                price800.innerText = `R$ ${(+149.99 + +40)
                    .toFixed(2)
                    .toString()
                    .replace(".", ",")}`;
                assinar800.href =
